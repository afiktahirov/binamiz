<div class="col-md-6" >
  <div class="modal fade" style="display: none;" id="detail-modal" tabindex="-1" role="dialog" aria-labelledby="object-detail-modal" aria-hidden="true">
    <div class="modal-dialog modal- modal-dialog-centered modal-" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h6 class="modal-title" id="modal-title-default">Obyekt Detalları</h6>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="object_number" readonly>
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
...
<script>
  ...
  function showDetail(id) {
    ...
    fetch(`{{ route('account.object.detail', '') }}/${id}`, { signal })
      .then(response => response.json())
      .then(data => {
        document.getElementById('object_number').value = data.object_number;
