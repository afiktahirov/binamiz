      ...
      <div class="modal-content">
          <div class="modal-header bg-primary text-center">
            <div class="modal-title text-center" id="detail-modal-label">
                <img src="{{ readSvg('img/sidebar/object') }}" width="40" height="40" class="invert-color" />
                <span >Obyektlər</span>
            </div>
          </div>
        <div class="modal-body">
          ...
          <div id="modal-content">
            <div class="soft-card">
              ...
              <div class="info-row"><span>Obyekt Nomrəsi:</span><span id="object_number" ></span></div>
              <div class="info-row"><span>Ölçüsü (m²):</span><span id="object_size" ></span></div>
...
<script>
  ...
  function showDetail(id) {
    ...
    currentAjax = $.ajax({
      url: `{{ route('account.object.detail', '') }}/${id}`,
      type: 'GET',
      dataType: 'json',
      beforeSend: function() {
      ...
      success: function(data) {
        $('#object_number').text(data.object_number);
        $('#object_size').text(data.object_size);
